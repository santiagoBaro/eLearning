...
class ParagraphElementForm extends StatefulWidget {
  final BookElement element;
  final Content content;
  ParagraphElementForm({Key key, this.element, @required this.content})
      : super(key: key);

  @override
  _ParagraphElementFormState createState() => _ParagraphElementFormState();
}

class _ParagraphElementFormState extends State<ParagraphElementForm> {
                ...
                onPressed: () async {
                  if (isSubmitEnabled) {
                    ...
                    BookElement nuevoElement = BookElement(
                        type: "paragraph", stringElements: textContrller.text);
                    var client = ApiClient();
                    if (widget.element != null) {
